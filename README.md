...
* **AI-Generated messages.** If OpenAI API key has been provided to the project, the `MessageBoard` component fetches AI-generated messages from the backend using a background task and replaces the original advert messages with AI-generated ones. `MessageCard` components display an icon to indicate AI-generated content.
